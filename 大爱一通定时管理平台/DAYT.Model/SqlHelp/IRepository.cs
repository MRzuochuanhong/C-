...
namespace DAYT.Model.SqlHelp
{
    public interface IRepository : IDisposable
    {
        ...
        /// <param name="updateLambda">跟新语句</param>
        /// <returns></returns>
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        List<T> GetAll<T>(Expression<Func<T, int>> orderLambda=null) where T : class;
        ...
        /// <returns></returns>
        List<T> QueryPro<T>(string Sql, List<T> Parms, CommandType CmdType = CommandType.Text) where T : class;
